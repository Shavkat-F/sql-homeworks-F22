...
(salesman_id int, name varchar(20), city varchar(20), commission decimal(4,2))
...
create table orders 
(ord_no int,purch_amt decimal(6,2),ord_date date,customer_id int,salesman_id int)
...
(year int, subject varchar(20), winner varchar(24), country varchar(14), category varchar(14))
...
(pro_id int, pro_name varchar(20), pro_price decimal(6,2), pro_com int)
...
(EMP_IDNO int, EMP_FNAME varchar(10), EMP_LNAME varchar(10), EMP_DEPT int)
...
(EMPLOYEE_ID int identity(100,1), FIRST_NAME varchar(14), LAST_NAME varchar(14), EMAIL varchar(20), PHONE_NUMBER varchar(20), HIRE_DATE date, JOB_ID varchar(14), SALARY decimal(7,2), COMMISSION_PCT decimal(3,2), MANAGER_ID int, DEPARTMENT_ID int)
...
(department_id int identity(10,10), department_name varchar(30), manager_id int, location_id int)
...
(location_id int identity(1000,100), street_address varchar(40), postal_code varchar(20), city varchar(30), state_province varchar(30), country_id varchar(4))
...
create table jobs (job_id varchar(20), job_title varchar(40), min_salary int, max_salary int)
...
(employee_id int, start_date date, end_date date, job_id varchar(30), department_id int)
